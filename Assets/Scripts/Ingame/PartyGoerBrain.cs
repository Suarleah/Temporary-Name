...
public class PartyGoerBrain : MonoBehaviour
{
    ...
    public enum Want {talk_with_someone, drink_with_someone, eat_with_someone, be_alone, dont_want_noise, sit_with_someone_with_mood_angry, sit_with_someone_with_mood_happy, sit_with_someone_with_mood_neutral, sit_with_someone_with_mood_sad, sit_with_someone_with_style_plain, sit_with_someone_with_style_fancy, sit_with_someone_with_style_professional, partnered, limited_number_of_people_at_table, sit_next_to_only_x_people, square_table, circle_table, soft_seat, wood_seat, end_of_a_table, drink_wine, center_of_table}; //styles are placeholders, styles are just for fun
